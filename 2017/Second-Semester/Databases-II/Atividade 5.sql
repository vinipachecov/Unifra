...
--Inserir os dados completos do PRODUTO.
  ...
  AS
  	...
  	-- Insere marca
  CREATE PROCEDURE SP_EXISTE_MARCA_INSERE (NOMEMARCA D_NOME)  
  RETURNS( 
  	IDDAMARCA D_INTEIRO                                               
  	)
  AS  	
  BEGIN
	  IF (NOT EXISTS (SELECT FIRST 1 M.NOME
	  			   FROM MARCA M
	  			   WHERE M.NOME = :NOMEMARCA))	  			   
	  			   THEN
		  			   BEGIN
			  			   INSERT INTO MARCA(NOME)
			  			   VALUES(:NOMEMARCA);			  			  		  			   
		  			   END 		  			   
		     SELECT FIRST 1 M.CODIGO
  			   FROM MARCA M 
			   WHERE M.NOME = :NOMEMARCA
			   INTO :IDDAMARCA; 
			   SUSPEND;	
...
BEGIN
	...
	INSERT INTO HITORICO ESTOQUE(IDCOMPRA, IDPROD, QUANT, VLRUNIT)
