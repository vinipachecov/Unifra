...
{
    /*!
     * @brief This class offers an interface to serialize/deserialize some basic types using CDR protocol inside an eprosima::FastBuffer.
    ...
    public:
        ...
        //! @brief This enumeration represents the two kinds of CDR serialization supported by eprosima::CDR.
        typedef enum
        {
        ...
        /*!
         * @brief This constructor creates an eprosima::Cdr object that can serialize/deserialize
         * the assigned buffer.
         *
